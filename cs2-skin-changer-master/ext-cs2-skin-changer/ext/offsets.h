...
namespace Offsets
{
    ...
    constexpr std::ptrdiff_t dwGameEntitySystem = cs2_dumper::offsets::client_dll::dwEntityList;
    ...
    constexpr std::ptrdiff_t m_iTeamNum = cs2_dumper::schemas::client_dll::C_BaseEntity::m_iTeamNum; // uint8
    ...
    constexpr std::ptrdiff_t m_designerName = cs2_dumper::schemas::client_dll::CEntityIdentity::m_designerName; // CUtlSymbolLarge

    constexpr std::ptrdiff_t m_hMyWeapons = cs2_dumper::schemas::client_dll::CPlayer_WeaponServices::m_hMyWeapons; // C_NetworkUtlVectorBase<CHandle<C_BasePlayerWeapon>>
    constexpr std::ptrdiff_t m_hActiveWeapon = cs2_dumper::schemas::client_dll::CPlayer_WeaponServices::m_hActiveWeapon; // CHandle<C_BasePlayerWeapon>
    ...
    constexpr std::ptrdiff_t m_skeletonInstance = cs2_dumper::schemas::client_dll::CBodyComponentSkeletonInstance::m_skeletonInstance; // CModelState
